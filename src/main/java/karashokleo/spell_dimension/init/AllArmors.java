...
public class AllArmors
{
    ...
    public static final ConfiguredArmorMaterial LIGHTNING_MATERIAL = new ConfiguredArmorMaterial(
        "lightning_robe",
        20, 10,
        WOOL_INGREDIENTS,
        1, 3, 2, 1,
    ...
    public static final ConfiguredArmorMaterial NETHERITE_LIGHTNING_MATERIAL = new ConfiguredArmorMaterial(
    ...
    public static final ConfiguredArmorMaterial SOUL_MATERIAL = new ConfiguredArmorMaterial(
        "soul_robe",
        20, 10,
        WOOL_INGREDIENTS,
        1, 3, 2, 1,
    ...
    public static final ConfiguredArmorMaterial NETHERITE_SOUL_MATERIAL = new ConfiguredArmorMaterial(
        "netherite_soul_robe",
        30, 15,
        NETHERITE_INGREDIENTS,
        3, 8, 6, 3,

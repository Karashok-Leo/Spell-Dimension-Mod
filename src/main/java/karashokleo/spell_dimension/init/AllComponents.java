...
public class AllComponents
{
    ...
    public static final ComponentKey<SpiritTomeComponent> SPIRIT_TOME = ComponentRegistry.getOrCreate(SpellDimension.modLoc("spirit_tome"), SpiritTomeComponent.class);
}

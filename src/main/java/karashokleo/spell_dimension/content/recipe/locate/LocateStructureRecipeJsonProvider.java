...
public class LocateStructureRecipeJsonProvider extends LocateRecipeJsonProvider
{
    protected final Identifier structure;

    public LocateStructureRecipeJsonProvider(Identifier recipeId, Identifier world, Ingredient ingredient, Identifier structure)
    {

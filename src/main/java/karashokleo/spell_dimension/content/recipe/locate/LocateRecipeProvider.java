...
public abstract class LocateRecipeProvider implements RecipeJsonProvider
{
    protected final Identifier recipeId;
    protected final Identifier world;
    protected final Ingredient ingredient;

    protected LocateRecipeProvider(Identifier recipeId, Identifier world, Ingredient ingredient)
    {

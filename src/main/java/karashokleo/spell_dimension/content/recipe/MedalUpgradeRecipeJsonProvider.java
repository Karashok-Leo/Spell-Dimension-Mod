...
public class MedalUpgradeRecipeJsonProvider implements RecipeJsonProvider
{
    ...
    public void serialize(JsonObject json)
    {
        ...
        json.add(MedalUpgradeRecipe.ORIGINAL_KEY, original.writeToJson(new JsonObject()));
        json.add(MedalUpgradeRecipe.UPGRADED_KEY, upgraded.writeToJson(new JsonObject()));
    }

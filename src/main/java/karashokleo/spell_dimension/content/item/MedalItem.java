...
public class MedalItem extends Item
{
    public MedalItem()
    {
        super(new FabricItemSettings().maxCount(1).rarity(Rarity.EPIC).food(new FoodComponent.Builder().alwaysEdible().build()));
    }
    ...
    {
        tooltip.add(SDTexts.TEXT$GAME_OVER$TRUE_MAGIC.get().formatted(Formatting.GOLD));
    }
}

...
public class SDSpellInfusionRecipes
{
    ...
    public static void add(Consumer<RecipeJsonProvider> exporter)
    {
        ...
        add(exporter, AllSpells.ARCANE_FLOURISH, SpellSchools.ARCANE, net.trique.mythicupgrades.block.MythicBlocks.AMETRINE_BLOCK.asItem());
        ...
        add(exporter, AllSpells.FIRE_BREATH, SpellSchools.FIRE, net.trique.mythicupgrades.block.MythicBlocks.TOPAZ_BLOCK.asItem());
        ...
        add(exporter, AllSpells.FLICKER_STRIKE, SpellSchools.FIRE, net.trique.mythicupgrades.block.MythicBlocks.RUBY_BLOCK.asItem());
        ...
        add(exporter, AllSpells.JUDGEMENT, SpellSchools.HEALING, net.trique.mythicupgrades.block.MythicBlocks.JADE_BLOCK.asItem());

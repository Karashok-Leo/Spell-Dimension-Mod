...
public class MendingEntry extends BaseEntryProvider
{
    ...
    protected List<BookPageModel> pages(BookContextHelper context)
    {
        ...
        this.lang().add(context.pageText(),
            """
                Mending Essence completely repairs an item and removes its accumulated repair penalties. Mending Essence can be crafted or obtained from loot.
                """
        );
        this.lang("zh_cn").add(context.pageTitle(), "修复精华");
        this.lang("zh_cn").add(context.pageText(),
            """
                修复精华可以完全修复一件物品, 并且清除其累积的修复惩罚。修复精华可以合成，也可以从战利品中获取。
                """
        );
